...
```groovy
dependencies {
    implementation("net.ximatai.muyun.database:muyun-database-jdbi:3.26.9")
}
```
...
```groovy
dependencies {
    implementation("net.ximatai.muyun.database:muyun-database-quarkus:3.26.9")
}
```
