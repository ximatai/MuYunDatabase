...
public class PostgresTableBuilderSqlDialect implements TableBuilderSqlDialect {
    ...
    public String createTableWithTempColumn(String schemaDotTable, String inheritClause) {
        return "create table " + schemaDotTable + "(a_temp_column int)" + inheritClause;
    }
    ...
    public String createIndex(String schemaDotTable, String indexName, List<String> columns, boolean unique) {
        ...
        return "create " + uniqueSql + "index if not exists " + indexName + " on " + schemaDotTable + "(" + String.join(",", columns) + ");";
    }
